 ...
 * @param {*} callbacks
 */
export const setConnectionStatusListener = (callbacks) => {
 ...
 */
export const setOnReceiveMessageListener = (callbacks) => {
 ...
 * @param {*} callbacks
 */
export const connect = (params, callbacks) => {
  const { token } = params;
 ...
 * @param {*} callbacks
 */
export const init = (params, callbacks) => {
  const { appKey } = params;

  RongIMClient.init(appKey);

  // 连接状态监听器
  setConnectionStatusListener(callbacks);
  // 设置消息监听器
 ...
 * 重连接融云服务
 */
export const reconnect = ({ success, error }) => {
  /*
...
export const joinChatRoom = ({
  chatRoomId, count = 20, success, error,
}) => {
 ...
 */
export const quitChatRoom = ({ chatRoomId, success, error }) => {
 ...
 */
export const getChatRoomHistoryMessages = ({
 ...
 */
export const registerMessage = (type, propertys) => {
...
export const sendPersonMessage = ({
  conversationType, targetId, content, success, error,
}) => {
  const propertys = ['type', 'msg', 'avatar', 'sentUser'];
